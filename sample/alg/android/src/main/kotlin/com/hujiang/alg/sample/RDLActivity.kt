 ...
 */
class RDLActivity: BaseActivity(), View.OnClickListener {
    ...
    override fun getLayoutId(): Int = R.layout.activity_rdl
    ...
    override fun onClick(v: View?) {
        when (v!!.id) {
            ...
            R.id.btnEncGo -> {
                ...
                thread {
                    val enc = AlgorithmUtils.rdlEncryptString(0, 1, key, ori)
                    val m = Message()
                    m.what = 100
                    m.obj = enc
                    h.sendMessage(m)
            ...
            R.id.btnDecGo -> {
                ...
                thread {
                    val dec = AlgorithmUtils.rdlDecryptString(0, 1, key, ori)
                    val m = Message()
                    m.what = 101
                    m.obj = dec
                    h.sendMessage(m)
