 ...
 */
class RSASSAActivity: BaseActivity(), View.OnClickListener {
    ...
    private val PUBKEY_PATH = "/sdcard/rsassa.pub"
    private val PUBKEY_PASS = "hujiang"
    private val PRIVKEY_PATH = "/sdcard/rsassa.priv"
    private val PRIVKEY_PASS = "hujiang"

    override fun getLayoutId(): Int = R.layout.activity_rsassa
    ...
    private val h = object: Handler() {
        override fun handleMessage(msg: Message?) {
            ...
            if (msg!!.what == 99) {
                ...
                Toast.makeText(this@RSASSAActivity, msg.obj as String, Toast.LENGTH_SHORT).show()
        ...
        when (v!!.id) {
            R.id.btnKeyPair -> {
                ...
                thread {
                    ...
                    val ret = AlgorithmUtils.rsassaGenerateKeys(1, PUBKEY_PASS, PRIVKEY_PASS, PUBKEY_PATH, PRIVKEY_PATH)
            ...
            R.id.btnEncGo -> {
                ...
                thread {
                    ...
                    val enc = AlgorithmUtils.rsassaSignString(1, 0, PRIVKEY_PASS, PRIVKEY_PATH, ori)
            ...
            R.id.btnVerifyGo -> {
                ...
                thread {
                    ...
                    val r = AlgorithmUtils.rsassaVerifyString(1, 0, PUBKEY_PASS, PUBKEY_PATH, e, ori)
