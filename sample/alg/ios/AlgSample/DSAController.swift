...
class DSAController: UIViewController {
    ...
    func threadGenerateKeyPair() {
        ...
        let ret = dsaGenerateKeys(0, NSString(string: PUBKEY_PASS).utf8String, NSString(string:PRIVKEY_PASS).utf8String, NSString(string: PUBKEY_PATH).utf8String, NSString(string: PRIVKEY_PATH).utf8String)
    ...
    func threadEncrypt() {
        ...
        let enc = dsaSignString(0, NSString(string: PRIVKEY_PASS).utf8String, NSString(string: PRIVKEY_PATH).utf8String, NSString(string: ori!).utf8String)
    ...
    func threadVerify() {
        ...
        let r = dsaVerifyString(0, NSString(string:PUBKEY_PASS).utf8String, NSString(string: PUBKEY_PATH).utf8String, NSString(string: e!).utf8String, NSString(string: ori!).utf8String)
